...
function Employees() {
    ...
    const showEmpDetails = (indexFromRow) => {
        ...
        const [targetEmployee] = data?.filter(
            (_, index) => index === indexFromRow
        );
        ...
        let empFields = [fName, mName, lName, position, attendanceType];
            ...
            <Container maxWidth="md">
                ...
                <TableContainer component={Paper}>
                    <Table className={classes.table} aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                <TableCell className={classes.tblHeading}>
                                    Name
                                </TableCell>
                                <TableCell
                                    className={classes.tblHeading}
                                    align="right"
                                >
                                    Position
                                </TableCell>
                        ...
                        <TableBody>
                            {data?.map((employee, index) => (
                                <TableRow
                                    hover
                                    onClick={() => showEmpDetails(index)}
                                    className={classes.employee__row}
                                >
